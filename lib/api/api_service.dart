...
class MealAPI {
  ...
  static Future<List<MealCategory>> categories() async {
  ...
  static Future<List<Meal>> byCategory(String c) async {
  ...
  static Future<List<Meal>> byArea(String a) async {
  ...
  static Future<List<Meal>> byIngredient(String i) async {
  ...
  static Future<List<Meal>> searchByName(String s) async {
  ...
  static Future<List<Meal>> byLetter(String l) async {
  ...
  static Future<Meal?> random() async {
